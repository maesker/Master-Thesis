 ...
 * */
AbstractComponent::AbstractComponent(std::string basedir, std::string conffile)
{
 ...
 * */
AbstractComponent::~AbstractComponent() throw()
{
    delete p_cm;
    delete log;
}
 ...
 * */
void AbstractComponent::init_default_cm()
{
    try
    {
    ...
    catch(ConfManException e)
    {
        ...
        //throw AbstractComponentException( s.c_str() );
    }
 ...
 * */
void AbstractComponent::init_logger()
{
 ...
 * inheriting class
 * */
int32_t AbstractComponent::stop()
{
    set_status(stopped);
}
 ...
 * */
int32_t AbstractComponent::detect_memoryleak_end()
{
 ...
 * is issued
 * */
void AbstractComponent::detect_memoryleak_start()
{
    mi_temp_start = mallinfo();
}
 ...
 * */
void AbstractComponent::set_status(ComponentStatus_t st)
{
    status = st;
}
 ...
 * @return status
 * */
ComponentStatus_t AbstractComponent::get_status()
{
    return status;
}
 ...
 * */
int16_t AbstractComponent::verify()
{
    if (!log->verify())
    {
        return 0;
