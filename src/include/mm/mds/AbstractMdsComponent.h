...
#include "exceptions/AbstractMdsComponentException.h"
...
{          
    ...
    public:
        ...
        explicit AbstractMdsComponent(std::string basedir, std::string conffile);
        ~AbstractMdsComponent() throw();
